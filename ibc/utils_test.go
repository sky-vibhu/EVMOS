...
func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("nexa", "nexapub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1",
						Receiver: "nexa1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
						Amount:   "123456",
					},
				),
			},
		...
		{
			"valid - cosmos sender, nexa recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
			...
			"nexa1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			"nexa1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			false,
		},
		{
			"valid - nexa sender, cosmos recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "nexa1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
		...
		{
			"valid - osmosis sender, nexa recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/aNEXB",
			"10",
			sdk.Coin{Denom: "aNEXB", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped aNEXB coin",
			"aNEXB",
			"10",
			sdk.Coin{Denom: "aNEXB", Amount: sdk.NewInt(10)},
		},
		// {
		// 	"get ibc wrapped aNEXB coin",
		// 	"transfer/channel-0/aNEXB",
		// 	"10",
		// 	sdk.Coin{Denom: teststypes.aNEXBIbcdenom, Amount: sdk.NewInt(10)},
		// },
		{
