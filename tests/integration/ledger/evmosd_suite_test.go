...
import (
	...
	"github.com/nexablock/nexablock/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/nexablock/nexablock/client/keys"
	nexakeyring "github.com/nexablock/nexablock/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupNexaApp() {
...
func (suite *LedgerTestSuite) nexaAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = nexakeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = nexakeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = nexakeyring.CreatePubkey
		options.LedgerAppName = nexakeyring.AppName
		options.LedgerSigSkipDERConv = nexakeyring.SkipDERConversion
	}
}
