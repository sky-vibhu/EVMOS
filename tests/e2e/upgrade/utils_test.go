...
// TestNexaVersionsLess tests the NexaVersions type's Less method with
// different version strings
func TestNexaVersionsLess(t *testing.T) {
	var version NexaVersions
...
// TestNexaVersionsSwap tests the NexaVersions type's Swap method
func TestNexaVersionsSwap(t *testing.T) {
	var version NexaVersions
	value := "v9.1.0"
...
// TestNexaVersionsLen tests the NexaVersions type's Len method
func TestNexaVersionsLen(t *testing.T) {
	var version NexaVersions = []string{"v9.1.0", "v10.0.0"}
