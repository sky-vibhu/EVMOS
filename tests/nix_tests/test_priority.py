...
def custom_nexa(tmp_path_factory):
    ...
    yield from setup_nexa(path, 26800, long_timeout_commit=True)
...
def test_native_tx_priority(custom_nexa):
    cli = custom_nexa.cosmos_cli()
    ...
    test_cases = [
        {
            ...
            "amount": "1000aNEXB",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}aNEXB",
        ...
        },
        {
            ...
            "amount": "1000aNEXB",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}aNEXB",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("aNEXB"))
