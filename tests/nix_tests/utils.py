...
TEST_CONTRACTS = {
    ...
    "ICS20I": "nexa/ics20/ICS20I.sol",
    "DistributionI": "nexa/distribution/DistributionI.sol",
    "StakingI": "nexa/staking/StakingI.sol",
}
...
def eth_to_bech32(addr, prefix=nexa_ADDRESS_PREFIX):
