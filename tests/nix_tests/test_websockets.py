def test_single_request_netversion(nexa):
    nexa.use_websocket()
    eth_ws = nexa.w3.provider
...
def test_batch_request_netversion(nexa):
    return


def test_ws_subscribe_log(nexa):
    return


def test_ws_subscribe_newheads(nexa):
    return
