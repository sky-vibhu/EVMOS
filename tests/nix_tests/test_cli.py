...
def test_block_cmd(nexa):
    ...
    # wait for height 10
    node1 = nexa.cosmos_cli(1)
    wait_for_block(node1, 10)

    # stop node1
    supervisorctl(nexa.base_dir / "../tasks.ini", "stop", "nexa_9000-1-node1")
    ...
    # start node1 again
    supervisorctl(nexa.base_dir / "../tasks.ini", "start", "nexa_9000-1-node1")
