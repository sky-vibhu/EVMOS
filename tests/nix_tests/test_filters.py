...
from .network import setup_custom_nexa, setup_nexa
from .utils import (
    ADDRS,
    CONTRACTS,
    deploy_contract,
...
def custom_nexa(tmp_path_factory):
    ...
    yield from setup_nexa(path, 26200)


@pytest.fixture(scope="module")
def nexa_indexer(tmp_path_factory):
...
@pytest.fixture(scope="module", params=["nexa", "geth", "nexa-ws", "enable-indexer"])
def cluster(request, custom_nexa, nexa_indexer, geth):
    """
