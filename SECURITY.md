...
Please refer to the official Nexa [bug bounty program](https://immunefi.com/bounty/nexa/)
...
- Use the Nexa [bug bounty program](https://immunefi.com/bounty/nexa/) on Immunefi to disclose all vulnerabilities,
...
Nexa uses the following disclosure process:
...
2. The team determines the vulnerability’s potential impact on Nexa.
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Nexa in a
    ...
    4. The nodes and validators update their Nexa and Ethermint dependencies to use these releases.
    5. A week (or less) after the security vulnerability has been patched on Nexa,
...
including but not limited to Nexa,
as secure as possible.

### Payment Process

The payment process will be executed according to Nexa’s Immunefi Bug Bounty program Rules.

### Contact

The Nexa Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@nexa.org](mailto:security@nexa.org)
