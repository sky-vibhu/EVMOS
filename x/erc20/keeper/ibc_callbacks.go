...
import (
	...
	"github.com/nexablock/nexablock/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "aNEXB"),
...
func (k Keeper) OnRecvPacket(
	...
	// Get addresses in `nexa1` and the original bech32 format
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on nexa need to have their tokens in the
