...
import (
	...
	"github.com/nexablock/nexablock/testutil/integration/grpc"
	"github.com/nexablock/nexablock/testutil/integration/network"
...
type CosmosTxArgs struct {
	// ChainID is the chain's id in cosmos format, e.g. 'nexa_9000-1'
	ChainID string
