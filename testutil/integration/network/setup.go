...
// createNexaApp creates an nexa app
func createNexaApp(chainID string) *app.Nexa {
	// Create nexa app
	db := dbm.NewMemDB()
...
func setStakingGenesisState(nexaApp *app.Nexa, genesisState simapp.GenesisState, overwriteParams StakingCustomGenesisState) simapp.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = nexaApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}

// setAuthGenesisState sets the auth genesis state
func setAuthGenesisState(nexaApp *app.Nexa, genesisState simapp.GenesisState, genAccounts []authtypes.GenesisAccount) simapp.GenesisState {
	authGenesis := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccounts)
	genesisState[authtypes.ModuleName] = nexaApp.AppCodec().MustMarshalJSON(authGenesis)
	return genesisState
}
...
func setBankGenesisState(nexaApp *app.Nexa, genesisState simapp.GenesisState, overwriteParams BankCustomGenesisState) simapp.GenesisState {
	...
	genesisState[banktypes.ModuleName] = nexaApp.AppCodec().MustMarshalJSON(bankGenesis)
	return genesisState
}
