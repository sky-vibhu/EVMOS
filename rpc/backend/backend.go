...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*nexatypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*nexatypes.TxResult, error)
...
type Backend struct {
	...
	indexer             nexatypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := nexatypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
