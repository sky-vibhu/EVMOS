...
There are the following license types that are used in the project:
    - ENCL: This license is used for all files containing Nexa IP.
...
LGPL3_LICENSE = [
    "// Copyright Tharsis Labs Ltd.(Nexa)\n",
    "// SPDX-License-Identifier:LGPL-3.0-only\n"
]

ENCL_LICENSE = [
    "// Copyright Tharsis Labs Ltd.(Nexa)\n",
    "// SPDX-License-Identifier:ENCL-1.0(https://github.com/nexa/nexa/blob/main/LICENSE)\n"
]
...
def check_license_in_file(file: str, checked_license: List[str]) -> bool or str:
    """
