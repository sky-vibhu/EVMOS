...
def test_check_if_in_exempt_files_not_included():
    file = "/Users/malte/dev/go/nexa/nexa/app/app.go"
...
def test_check_if_in_exempt_files_included():
    ...
    file = "/Users/malte/dev/go/nexa/nexa/x/erc20/keeper/proposals.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/nexa/nexa/x/erc20/types/utils.go"
    assert cl.check_if_in_exempt_files(file) is True

    file = "/Users/malte/dev/go/nexa/nexa/x/evm/genesis.go"
    assert cl.check_if_in_exempt_files(file) is False
