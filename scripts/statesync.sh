...
# Initialize chain.
nexad init test --chain-id nexa_9000-2

# Get Genesis
wget https://archive.nexa.org/mainnet/genesis.json
mv genesis.json ~/.nexad/config/

wget -O ~/.nexad/config/adrbook.json https://snapshot.notional.ventures/nexa/addrbook.json
...
export NEXAD_P2P_MAX_NUM_INBOUND_PEERS=200
export NEXAD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export NEXAD_STATESYNC_RPC_SERVERS="https://nexa-rpc.polkachu.com:443,https://rpc-nexa-ia.notional.ventures:443"
