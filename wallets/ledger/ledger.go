...
import (
	...
	"github.com/nexablock/nexablock/wallets/accounts"
	"github.com/nexablock/nexablock/wallets/usbwallet"
)
...
func NexaLedgerDerivation() Secp256k1DerivationFn {
	nexaSECP256K1 := new(NexaSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return nexaSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &NexaSECP256K1{}

// NexaSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type NexaSECP256K1 struct {
	*usbwallet.Hub
...
func (e NexaSECP256K1) Close() error {
...
func (e NexaSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "nexa")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e NexaSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e NexaSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte) ([]byte, error) {
...
func (e NexaSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *NexaSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
