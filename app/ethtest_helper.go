...
// EthSetup initializes a new NexaApp. A Nop logger is set in NexaApp.
func EthSetup(isCheckTx bool, patchGenesis func(*Nexa, simapp.GenesisState) simapp.GenesisState) *Nexa {
	return EthSetupWithDB(isCheckTx, patchGenesis, dbm.NewMemDB())
}

// EthSetupWithDB initializes a new NexaApp. A Nop logger is set in NexaApp.
func EthSetupWithDB(isCheckTx bool, patchGenesis func(*Nexa, simapp.GenesisState) simapp.GenesisState, db dbm.DB) *Nexa {
	chainID := utils.TestnetChainID + "-1"
	app := NewNexa(log.NewNopLogger(),
		db,
		nil,
		true,
		map[int64]bool{},
