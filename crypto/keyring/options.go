...
import (
	...
	"github.com/nexablock/nexablock/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Nexa uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Nexa:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Nexa for the Ledger device:
	...
	// LedgerDerivation defines the Nexa Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.NexaLedgerDerivation()
