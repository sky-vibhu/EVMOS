...
import (
	...
	cryptocodec "github.com/nexablock/nexablock/crypto/codec"
	enccodec "github.com/nexablock/nexablock/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("nexa", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, nexatypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, nexatypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(nexatypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Nexa implementation
	...
	// Equality of Eth and Nexa implementation
	...
	// Inequality of wrong derivation path of Eth and Nexa implementation
