...
func Call(ctx sdk.Context, app *nexaapp.Nexa, args CallArgs) (res abci.ResponseDeliverTx, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
	...
	res, err = nexautil.DeliverEthTx(app, args.PrivKey, msg)
	if err != nil {
...
func CallContractAndCheckLogs(ctx sdk.Context, app *nexaapp.Nexa, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ResponseDeliverTx, *evmtypes.MsgEthereumTxResponse, error) {
