...
func (s *PrecompileTestSuite) TestApprove() {
	...
	testCases := []struct {
		...
		{
			"success - MsgDelegate with 1 Nexa as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		},
		{
			...
			func(_ *vm.Contract) []interface{} {
				...
				var err error
				s.ctx, err = nexautil.Commit(s.ctx, s.app, time.Second, nil)
				...
				s.ctx, err = nexautil.Commit(s.ctx, s.app, time.Hour*24*365, nil)
				s.Require().NoError(err, "failed to commit block")
		...
		{
			"success - MsgUndelegate with 1 Nexa as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate with 1 Nexa as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
		...
		{
			"success - MsgRedelegate, MsgUndelegate and MsgDelegate with 1 Nexa as limit amount",
			func(_ *vm.Contract) []interface{} {
				return []interface{}{
					s.address,
					big.NewInt(1e18),
...
func (s *PrecompileTestSuite) TestDecreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - decrease delegate authorization allowance by 1 Nexa",
			func(_ *vm.Contract) []interface{} {
...
func (s *PrecompileTestSuite) TestIncreaseAllowance() {
	...
	testCases := []struct {
		...
		{
			"success - increase delegate authorization allowance by 1 Nexa",
			func() []interface{} {
...
func (s *PrecompileTestSuite) TestRevoke() {
	...
	granteeAddr := nexautiltx.GenerateAddress()
